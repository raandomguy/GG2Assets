...
CTFPlayer.SetParentLocalOriginDo <- function(child, parent, attachment = null) {
	...
	if (attachment != null) {
		...
		child.AcceptInput("SetParentAttachmentMaintainOffset", attachment, null, null)
	}
}
CTFBot.SetParentLocalOriginDo <- CTFPlayer.SetParentLocalOriginDo
...
CTFPlayer.GetWearable <- function(model, bonemerge = true, attachment = null, offsets = null)
{
	...
	this.SetParentLocalOriginDo(wearable, this, attachment)
