::PEA_GLOBAL <-
{
	...
	[
		...
		["CTFPlayer", ["IsGrounded", "GetWeapon", "GetWearable"]],
		["CTFBot", ["IsGrounded", "GetWeapon", "GetWearable", "Zombify"]]
	]
	...
	GLOBAL_CALLBACKS =
	{
		...
		OnGameEvent_player_death = function(params)
		{
			...
			if (dead_player.IsFakeClient())
			{
				...
				{
					if (child.GetClassname() == "tf_wearable" && child.GetScriptScope() != null) EntFireByHandle(child, "Kill", null, -1.0, null, null)
				}
...
CTFPlayer.GetWearable <- function(model, bonemerge = true, attachment = null, offsets = null)
{
	...
	NetProps.SetPropEntity(wearable, "m_hMovePeer", this.FirstMoveChild())
	NetProps.SetPropEntity(this, "m_hMoveChild", wearable)
	NetProps.SetPropEntity(wearable, "m_hMoveParent", this)
	...
	if (attachment != null) EntFireByHandle(wearable, "SetParentAttachment", attachment, 0.1, null, null)
